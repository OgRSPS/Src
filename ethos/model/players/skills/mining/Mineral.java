...
public enum Mineral {
			...
			COAL(new int[] { 7489, 9717, 9718, 9719, 2096, 13714, 13706, 7456}, "none", 30, 50, 3, 15, 29, 14600, true, generateExclusive(453)), 
			...
			AMETHYST(new int[] { 30371, 30372 }, "mithril", 92, 140, 0, 100, 40, 11500, true, generateExclusive(21347)),			
