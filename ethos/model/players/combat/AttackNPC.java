...
import ethos.model.npcs.bosses.wildypursuit.Galvek;
...
public class AttackNPC {
	...
	public static void calculateCombatDamage(Player attacker, NPC defender, CombatType combatType, Special special) {
		...
		if (damage3 > -1) {
			//attacker.sendMessage("THIs added");
			attacker.getDamageQueue().add(new Damage(defender, damage3, 3, attacker.playerEquipment, hitmark3, combatType));
		}
	}
