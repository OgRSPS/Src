...
public class BankX2 implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		if (c.debugMessage)
			c.sendMessage("Bank X2: amount: "+Xamount+", removeId: "+c.xRemoveId+", item: " + c.item + " interface: " + c.xInterfaceId);
		...
		if(c.wogw) {
			//c.sendMessage("Amnt" + Xamount);
			//c.sendMessage(" " + c.wogw);
		...
		if (c.sellingX) {
	    	...
	    	//c.sendMessage("selling:" + c.XremoveID + " " + c.XremoveSlot + " " + amount);
