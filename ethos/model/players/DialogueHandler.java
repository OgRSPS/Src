...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 1703:
			...
			case 94399:
				sendOption2("Teleport me home", "Open the Teleport Panel");
		...
		case 704:
			sendNpcChat("Alright, that will be 5m coins. You must have the draconic",
					"visage and an antifire shield as well of course.");
			c.nextChat = 705;
			break;

		case 705:
			sendOption2("Okay, here you go", "I don't have that kind of wealth!");
		...
		case 89:
			sendNpcChat1("Mac. What's it to you?", 6481, "Mac");
			c.nextChat = 90;
			break;
		...
		case 92:
			sendNpcChat1("S'me cape.", 6481, "Mac");
			c.nextChat = 93;
			break;
		...
		case 96:
			sendNpcChat1("Get it dirty.", 6481, "Mac");
			c.nextChat = 87;
			break;
		...
		case 100:
			sendNpcChat1("Many monies.", 6481, "Mac");
			c.nextChat = 101;
			break;
		...
		case 112:
			sendNpcChat1("Bath XP waste", 6481, "Mac");
			c.nextChat = 87;
			break;
		...
		case 1500:
			sendPlayerChat1("Wow what has happened here? That doesn't look good!");
			c.nextChat = 1501;
			break;
			
		case 1501:
			sendNpcChat2("We pushed it too far! JalYt would not understand.", "The memories, we needed them. Now big Inferno." , 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1502;
			break;
		...
		case 1503:
			sendNpcChat2("This is our birthing pool. TzHaar are born from eggs", "incubated in this large pool here.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1504;
			break;	
			
		case 1504:
			sendNpcChat2("When hatched, we retain memories. Memories and know-", "-ledge passed on from ancestors who returned to the lava.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1505;
			break;		
			
		case 1505:
			sendPlayerChat1("Something doesn't seem right... There's a large opening.");
			c.nextChat = 1506;
			break;
		
		case 1506:
			sendPlayerChat1("What happened here?");
			c.nextChat = 1507;
			break;
		
		case 1507:
			sendNpcChat2("We went too far... way too far, we need the memories.", "JalYt would not understand.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1508;
			break;	
		
		case 1508:
			sendPlayerChat1("Please help me to understand then.");
			c.nextChat = 1509;
			break;
		
		
		case 1509:
			sendNpcChat3("We TzHaar have special ability. When incubated in lava,", "a hatched TzHaar retains knowledge and memories of", "ancestors who returned to the lava.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1510;
			break;	
			
		case 1510:
			sendNpcChat2("Not all memories though, those about earliest ancestors", "were not being retained. We experiment.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1511;
			break;
		
		case 1511:
			sendNpcChat3("We increased the depth at which the eggs are incubated.", "Over time this worked, newly hatched TzHaar had more", "memories of lost history!", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1512;
			break;	
			
		case 1512:
			sendPlayerChat2("That sounds fantastic though, uncovering the past", "to determine where your species originated?");
			c.nextChat = 1513;
			break;
			
		case 1513:
			sendNpcChat2("Yes, but you JalYt do not understand, we kept pushing it.", "We wanted answers, but too deep we went.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1514;
			break;
		case 1514:
			sendNpcChat2("Eventually the pool collapsed into a sink hole, huge", "inferno there. This was big ancient incubation chamber.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1515;
			break;
			
		case 1515:
			sendNpcChat3("We hatched eggs in there and it was not a good decision.", "They were so different, bigger, stronger, and fought each", "other for dominance.", 7690, "TzHaar-Ket-Keh");
			...
			//has not sacrificed a cape yet
		case 1516:
			sendNpcChat3("Instead of knowledge, we now have a prison of dangerous", "TzHaar creatures - it gets worse but I cannot trust", "JalYt with this knowledge yet.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1517;
			break;
			
		case 1517:
			sendPlayerChat1("Can I go down there?");
			if(!c.hasSacrificedFcape) {
				c.nextChat = 1518;
				break;
			} else {
		...
		case 1518:
			sendNpcChat2("JalYt, we need help, but this is extremely dangerous.", "TzHaar not strong enough to take control back.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1519;
			break;
			
		case 1519:
			sendNpcChat2("We are worried about trusting JalYt to take", "on this task for us.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1520;
			break;
			
		case 1520:
			sendPlayerChat1("Let me prove it.");
			c.nextChat = 1521;
			break;
		case 1521:
			sendNpcChat2("I have one idea, if you could sacrifice your fire cape", "to me, I can take your word.", 7690, "TzHaar-Ket-Keh");
			if(c.getItems().playerHasItem(6570)) {
				c.nextChat = 1522;
				break;
			} else if(c.getItems().isWearingAnyItem(6570)) {
				c.nextChat = 1527;
				break;
			} else {
				c.nextChat = 1528;
		...
		case 1522:
			sendPlayerChat1("Okay, I'd like to sacrifice my fire cape.");
			c.nextChat = 1523;
			break;
			
		case 1523:
			sendNpcChat1("Very well, just hand it over.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1524;
			break;
			
		case 1524:
			sendOption2("@red@Really sacrifice your Fire cape?", "No, I'd like to keep it.", "Yes, I'd like to sacrifice it.");
			c.dialogueAction = 1260;
			break;
			
		case 1525:
			sendStatement("You hand over your cape to TzHaar-Ket-Keh.");
			c.nextChat = 1526;
			break;
			
		case 1526:
			sendNpcChat1("Give it your best shot JalYt-Ket-Xo-" + c.playerName + ".", 7690, "TzHaar-Ket-Keh");
			c.nextChat = -1;
			break;
			
		case 1527:
			sendPlayerChat1("Let me just take it off first.");
			c.nextChat = -1;
			break;
			
		case 1528:
			sendPlayerChat1("I don't have a fire cape on me unfortunately.");
			c.sendMessage("@red@You must trade a fire cape to TzHaar-Ket-Keh in order to gain his trust.");
			c.nextChat = -1;
			break;
		
		case 1529:
			sendPlayerChat1("Sorry, I want to keep it for now.");
			c.sendMessage("@red@You must trade a fire cape to TzHaar-Ket-Keh in order to gain his trust.");
			c.nextChat = -1;
			break;
			
			//has already sacrificed a cape
		case 1530:
			sendNpcChat2("Instead of knowledge, we now have a prison of dangerous", "TzHaar creatures... and they're not under our control.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1531;
			break;
		
		case 1531:
			sendNpcChat3("One grew incredibly strong, powerful, he controls those", "creatures in the prison and TzKal-Zuk, as we call him", "is hungry.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1532;
			break;
			
		case 1532:
			sendNpcChat2("Hungry for memories, memories beyond the Inferno, which", "only TzHaar on the surface can provide.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1533;
			break;
			
		case 1533:
			sendPlayerChat1("Do you know what he's planning? What are you doing?");
			c.nextChat = 1534;
			break;
		
		case 1534:
			sendNpcChat3("We can only guess one day he will want to scale up onto", "the surface himself. We are keeping him at bay by", "offering sacrifices for him to feast on.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1535;
			break;
			
		case 1535:
			sendPlayerChat1("Is there no way to take him out?");
			c.nextChat = 1536;
			break;
		case 1536:
			sendNpcChat3("We hoped you, with your fancy JalYt weaponry would be", "our best hope. You proved your commitment by", "sacrificing your fire cape.", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1517;
			break;
			
		case 1537:
			sendNpcChat2("You can head into The Inferno anytime. We trust you", "to help us JalYt-Ket-Xo-" + c.playerName + ".", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1538;
			break;
		case 1538:
			sendPlayerChat1("I'll do my best.");
			c.nextChat = -1;
			break;
			/*sendNpcChat2("", "", 7690, "TzHaar-Ket-Keh");
			c.nextChat = 1514;
			break;
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.",
					"Interested in becoming an Anguish <img=4>@red@Donator@bla@?",
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Anguish to be a travelling banker!", c.talkingNpc,
					"Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 645:
			sendNpcChat("You've made it through!", "You have the option to play as an <img=12></img> Iron Man,",
					"<img=13></img> Ultimate Iron Man, or Regular.", "Choose from the following interface.");
			c.nextChat = 646;
			break;
		...
		case 647:
			if (c.getMode().getType().equals(ModeType.REGULAR)) {
				...
				sendNpcChat("You have gotten to a mode that is in progress. Please report how you found it to admin");
			} else if(c.getMode().getType().equals(ModeType.IRON_MAN)){
				sendNpcChat("You have chosen to play as an Ironman.",
						"Take this set of armour to help you on your way.");
			} else if(c.getMode().getType().equals(ModeType.ULTIMATE_IRON_MAN)){
				sendNpcChat("You have chosen to play as an Ultimate Ironman.",
						"Take this set of armour to help you on your way.");
			}
			c.nextChat = 648;
			break;
		...
		case 650:
			if (c.getMode().isIronman() || c.getMode().isUltimateIronman()) {
				...
				sendNpcChat("Hello there " + c.playerName + ".",
						"I'm sorry, I am only here to serve Iron Man players.", "I cannot assist you in any way.");
				c.nextChat = -1;
			}
			break;
		...
		case 673:
			sendNpcChat("Glad to see you have joined Anguish!", "To start, this is our lovely home area.",
					"Let me show you around!");
			c.nextChat = 674;
			break;

		case 674:
			c.getPA().movePlayer(3078, 3498, 0);
			sendNpcChat("There are many shops located around", " our home, check them out!",
					"You'll find what you need.");
			c.nextChat = 676;
			break;

		case 676:
			c.getPA().movePlayer(3097, 3512, 0);
			sendNpcChat("This is our Achievement Hall", "Here you can find the vote store",
					"and information on your account.");
			c.nextChat = 677;
			break;

		case 677:
			c.getPA().movePlayer(3108, 3503, 0);
			sendNpcChat("Located here is a furnace,", " and pottery furnance",
					"for your convienience.");
			c.nextChat = 678;
			break;

		case 678:
			c.getPA().movePlayer(3101, 3497, 0);
			sendNpcChat("Here you can cook", "all of your food.",
					"There may be faster locations though!");
			c.nextChat = 679;
			break;

		case 679:
			c.getPA().movePlayer(3093, 3495, 0);
			sendNpcChat("Here you can replenish your", "health, special attack,",
					" and run after a cooldown timer.");
			c.nextChat = 680;
			break;
		case 680:
			c.getPA().movePlayer(3087, 3493, 0);
			sendNpcChat("Finally, to teleport you", "can use the tab located",
